...
class MarketDataTool(BaseTool):
    ...
    description = (
        ...
        "as_of/latest_ohlcv/derived/provenance summary is authoritative. After a "
        "successful Korean result with pykrx_mcp OHLCV, do not call get_market_data "
        "again for the same symbol and requested range or any subrange; reuse the "
        "returned derived values. If a derived value is absent, report it as unavailable "
        "instead of fetching price data again. Fundamentals, market-cap, or investor-flow "
        "failure never justifies another price query. Do not call raw pykrx OHLCV or any "
        "other price provider after success. "
