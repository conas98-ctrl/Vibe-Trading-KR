"""KIS Open API connector bootstrap.

This slice wires KIS into the connector registry and safety gates. Endpoint
coverage is added through the Korean broker API catalog layer before live
credential smoke tests are considered complete.
"""
